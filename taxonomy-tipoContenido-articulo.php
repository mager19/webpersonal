		 ...
		 if ( have_posts() ) : ?>
				...
				<header class="trabajos-header">
					<div class="container">
						<div class="row">
							<div class="col-12">
								<h2><img src="<?php echo get_template_directory_uri() ?>/img/article.png">Artículos</h2>
								<div class="archive-description">A veces me gusta escribir, aquí algunos de ellos.</div>		
							</div>
						</div>
					</div>					
				</header><!-- .page-header -->
